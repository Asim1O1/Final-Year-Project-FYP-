...
export const handleHospitalRegistration = createAsyncThunk("hospital/addHospital", async(hospitalData, {rejectWithValue})=>{
    try {
        const response = await hospitalService.addHospitalService(hospitalData);
        console.log("The response in the handleHospitalRegistration was: ", response);
        ...
        return rejectWithValue(
            createApiResponse({
                isSuccess: false,
                message: error?.message || "Failed to register hospital. Please try again.",
