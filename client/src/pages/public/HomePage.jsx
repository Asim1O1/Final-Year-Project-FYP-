...
const HomePage = () => {
  ...
  return (
    // Add overflow-x: hidden to the root container to prevent horizontal scrollbar
    <Box position="relative" overflow="hidden">
      {/* Decorative background elements - modified to prevent overflow */}
      <Box
        position="absolute"
        top="0"
        right="0"
        ...
        opacity="0.3"
        transform="skewX(-12deg)" // Removed translateX that was causing overflow
        zIndex="0"
      ...
      >
        {/* Wave separator at top - Make sure this doesn't cause overflow */}
        <Box
          position="absolute"
          top="-2px"
          left="0"
      ...
      >
        ...
        {/* Decorative dots pattern - ensure it doesn't cause overflow */}
