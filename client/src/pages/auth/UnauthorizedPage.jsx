      ...
      <div className="max-w-xl w-full bg-white shadow-2xl rounded-2xl border border-sky-100 overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          <div className="flex items-center space-x-4 bg-sky-50 p-4 rounded-lg border border-sky-200">
            ...
            <div>
              <h2 className="font-semibold text-xl text-sky-800">Secure Healthcare Platform</h2>
              <p className="text-gray-600">Protecting sensitive medical information</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="font-semibold text-yellow-800">Access Requirements</span>
              </div>
              <p className="text-gray-700">
                This {contentType} requires special authorization. 
                Only <span className="font-bold text-yellow-900">{requiredRole}</span> can access this resource.
              </p>
            </div>
            
            <div className="space-y-2">
              <button 
                onClick={handleLoginClick} // Use the defined function here
